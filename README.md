<p align="center">
  <img src="./assets/banner.svg" alt="Jaxan Luo — Multimodal Research × ML Systems" width="100%" />
</p>
...
- an ML Engineer at **Waymo**, working on reliable simulation inference and evaluation;
...
- **2026.07** — Landed shared reference-encoding infrastructure in SGLang-Omni for real-time TTS pipelines ([#926](https://github.com/sgl-project/sglang-omni/pull/926), [#927](https://github.com/sgl-project/sglang-omni/pull/927)).
...
| [**SGLang-Omni**](https://github.com/sgl-project/sglang-omni) · [Selected PRs](https://github.com/sgl-project/sglang-omni/pulls?q=is%3Apr+author%3Aluojiaxuan) | Mixed-chunk scheduling, tensor-parallel correctness, topology-aware collectives, and shared services for multimodal/TTS serving. |
...
| When | Where | Focus |
| --- | --- | --- |
| 2026–present | **Waymo** · Machine Learning Engineer | Simulation inference, fidelity, reproducibility, and resource-aware serving |
