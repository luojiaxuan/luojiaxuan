...
| [**Hierarchical GRPO for Speech RL**](https://github.com/owaski/HPO) · [Paper · ACL 2026 Oral](https://arxiv.org/abs/2604.21045) | Refactored the task-specific HPO/SST trainer into a reusable GRPO framework with modular rollout, rewards, typed adapters, and task plug-ins. |
